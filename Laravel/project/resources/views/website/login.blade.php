    ...
    <div class="container pt-lg-5 pt-md-4 pt-2">
        ...
        <div class="row">
            ...
            <div class="offset-md-3 col-md-6 right-cont-contact ps-md-4 mt-md-0 mt-5">
                <form method="post" action="{{url('/authlogin')}}" class="w3layouts-contact-fm" action="" method="post">
                    @csrf
                    <div class="form-group mb-3">
                        <input class="form-control" value="{{old('email')}}" type="email" name="email" id="w3lSender"
                    ...
                    <div class="form-group mb-3">
                        <input class="form-control" value="{{old('pass')}}" type="password" name="pass" id="w3lSender"
